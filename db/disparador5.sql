...
BEGIN
    FOR fecha IN horas LOOP
      IF (fecha.fechaFin + 1/24 > :new.fechaInicio AND fecha.fechaInicio < :new.fechaInicio)OR fecha.fechaFin = :new.fechaInicio OR (fecha.fechaInicio < :new.fechaFin + 1/24 AND fecha.fechaInicio > :new.fechaInicio)
